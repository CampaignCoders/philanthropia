    ...
    function _class(props, context) {
      ...
      _this.wrappedCreateToken = function () {
        ...
        if (typeOrOptions && (typeof typeOrOptions === 'undefined' ? 'undefined' : _typeof(typeOrOptions)) === 'object') {
          ...
          return _this.context.stripe.createToken(typeOrOptions, options);
        } else {
      ...
      _this.wrappedCreateSource = function () {
        ...
        if (options && (typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object') {
          ...
          if (element) {
            ...
            return _this.context.stripe.createSource(options);
          } else {
...
var _extractOptions = function _extractOptions(props) {
  var className = props.className,
      ...
      options = _objectWithoutProperties(props, ['className', 'elementRef', 'onChange', 'onFocus', 'onBlur', 'onReady']);
...
var Element = function Element(type) {
  ...
  return _temp = _class = function (_React$Component) {
    ...
    _createClass(_class, [{
      ...
      key: 'render',
      value: function render() {
        return React.createElement('div', { className: this.props.className, ref: this.handleRef });
      }
    }]);
